...
class PageController extends Controller
{
    ...
    public function edit($role = "", $id)
    {
        if (!empty($id)) {
            ...
            $child_parent_id = DB::table('parent_child_pages')->select('parent_id')->where('child_id', $id)->first();
            ...
            return view('admin.pages.edit', compact('page', 'parent_page', 'parent_selected_id', 'user_role', 'id', 'has_child', 'seo_desc'));
        }
    }
    ...
    public function destroy(Request $request)
    {
        ...
        if (!empty($id)) {
            ...
            if (!empty($child_pages)) {
                ...
                $relation = DB::table('pages')->select('relation_type')->where('id', $id)->first();
