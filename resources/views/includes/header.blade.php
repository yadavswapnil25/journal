@php
    ...
    $published_editions = App\Models\Edition::getPublishedEdition();
@endphp
@auth
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="sj-navigationarea">
                <strong class="sj-logo">
                    <a href="{{url('/')}}">
                        <img id="site_logo" src="{{asset(App\Models\SiteManagement::getLogo())}}" alt="{{trans('prs.scientific_journal')}}">
                    </a>
                </strong>
                            ...
                            <ul>
                                ...
                                @if (!empty($pages))
                                    @foreach ($pages as $page)
                                        @php
                                            $page_has_child = App\Models\Page::pageHasChild($page->id); $pageID = Request::segment(2);
                                                ...
                                                @if (!empty($page_has_child))
                                                    <ul class="sub-menu">
                                                        @foreach($page_has_child as $parent)
                                                            @php $child = App\Models\Page::getChildPages($parent->child_id);@endphp
