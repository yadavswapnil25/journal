                        ...
                        @if($articles->count() > 0)
                            @foreach($articles as $article)
                                ...
                                <li id="collapseOne-{{{$article->id}}}" class="collapse sj-active sj-userinfohold" aria-labelledby="headingOne-{{{$article->id}}}" data-parent="#accordion">
                                    <div class="sj-userinfoimgname">
                                        ...
                                        @if ($article->status == "accepted_articles")
                                            @php
                                                ...
                                                $editionStatus = App\Models\Edition::getEditionStatusByID($article->edition_id);
                                            @endphp
                                                    ...
                                                    <fieldset>
                                                        <div class="form-group">
                                                            <upload-files-field
                                                                ...
                                                                :uploaded_file="'{!! App\Models\Article::getArticleFullName($article->publish_document) !!}'"
                                    ...
                                    @php $comments = App\Models\Article::getAdminArticleComments($article->id,'reviewer'); @endphp
                                    @if (!empty($comments))
