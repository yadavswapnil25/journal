    ...
    var new_article_obj = new Vue({
        ...
        methods: {
            addAnother: function () {
                ...
                this.authors.push(Vue.util.extend({}, this.author, { count: this.author.count++ }));
            },
            ...
            getAbstractWordCount: function (text) {
                var t = (text || '').trim();
...
if (document.getElementById("article")) {
    var vm = new Vue({
        ...
        methods: {
            ...
            deleteArticle: function (event, delete_title, delete_message, deleted) {
                var element = event.currentTarget;
                var self = this;
                swal({
                    title: delete_title,
